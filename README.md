# SpringBoot-JPA-mysql-MinAir
  ...
  * http://18.118.186.146/docs/index.html API rest-docs 주소
  * AWS EC2와 AWS RDS MariaDB를 통해 http://18.118.186.146/ 배포
...
## 현재까지 고민
 * Api는 응답Status를 통해 해당 예외에 대한 큰 설명이 가능. 웹파트는 AdviceController를 통해 해당 어플리케이션에서 발생하는 예외를 한번에 잡아서 예외별로 처리해주었다.
